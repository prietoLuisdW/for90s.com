  ...
  template: `
    <section class="space-y-8 md:space-y-10">
      <div class="grid grid-cols-1 xl:grid-cols-12 gap-6 lg:gap-8 items-stretch">
        <!-- Hero principal -->
        <div class="xl:col-span-8 rounded-3xl border p-8 md:p-10 lg:p-12 shadow-sm"
          ...
          <div class="max-w-3xl">
            ...
            <h2 class="mt-5 text-4xl md:text-5xl xl:text-6xl font-bold tracking-tight leading-tight">
              Impulso ideas, automatizo procesos y transformo tareas administrativas en soluciones más claras.
            </h2>

            <p class="mt-5 text-base md:text-lg leading-8 opacity-80 max-w-2xl">
            ...
            <div class="mt-8 flex flex-wrap gap-3">
              <span
                class="inline-flex items-center rounded-full border px-3 py-1 text-xs md:text-sm"
                :class="themeClasses.badge"
              >
        ...
        <!-- Panel lateral -->
        <div class="xl:col-span-4 rounded-3xl border p-6 md:p-7 shadow-sm"
             :class="themeClasses.panel">
          <div class="flex items-center gap-4">
            <div class="w-16 h-16 rounded-2xl overflow-hidden border-2 shrink-0"
            ...
            <div class="min-w-0">
              <h3 class="text-lg font-semibold truncate">For90s .com</h3>
              <p class="text-sm opacity-70 truncate">Portafolio profesional</p>
            </div>
          </div>

          <div class="mt-6 space-y-3">
            <div class="rounded-2xl border p-4" :class="themeClasses.subpanel">
              <p class="text-xs uppercase tracking-[0.18em] opacity-60">Enfoque</p>
            ...
            <div class="rounded-2xl border p-4" :class="themeClasses.subpanel">
              <p class="text-xs uppercase tracking-[0.18em] opacity-60">Contenido</p>
              <p class="mt-2 text-sm leading-6 opacity-90">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
        <article class="rounded-2xl border p-6 shadow-sm" :class="themeClasses.panel">
          <p class="text-xs uppercase tracking-[0.18em] opacity-60">Automatización</p>
          <h3 class="mt-3 text-xl font-semibold">Procesos más fluidos</h3>
        ...
        <article class="rounded-2xl border p-6 shadow-sm" :class="themeClasses.panel">
          <p class="text-xs uppercase tracking-[0.18em] opacity-60">Apps de apoyo</p>
          <h3 class="mt-3 text-xl font-semibold">Soluciones para operación diaria</h3>
          <p class="mt-3 text-sm leading-7 opacity-80">
            Diseño herramientas ligeras para acompañar procesos internos, seguimiento,
            registro, control y gestión administrativa.
          </p>
        </article>

        <article class="rounded-2xl border p-6 shadow-sm" :class="themeClasses.panel">
          <p class="text-xs uppercase tracking-[0.18em] opacity-60">Conocimiento</p>
          <h3 class="mt-3 text-xl font-semibold">Ideas que se comparten</h3>
          <p class="mt-3 text-sm leading-7 opacity-80">
